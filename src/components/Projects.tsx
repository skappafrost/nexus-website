...
const projects = [
  ...
  },
  {
    ...
    tags: ["Bash", "CDP", "Python", "Automation"],
    status: "Active",
    desc: "A systematic reconnaissance framework for web application security assessment. Capabilities include API discovery from JS bundles, authentication bypass workflows, credential stuffing automation, CORS/security header audits, and structured reporting with defensive recommendations.",
    links: {
      github: "https://github.com/skappafrost",
    },
  },
  {
    icon: Workflow,
    ...
    tags: ["DSPy", "GEPA", "Python", "ML"],
    status: "Research",
    desc: "An autonomous pipeline that evolves agent skills through programmatic optimization. Uses DSPy + GEPA for automated prompt optimization and skill refinement. The agent can identify knowledge gaps, propose improvements, and validate changes — all without human intervention.",
    links: {
      github: "https://github.com/skappafrost",
    },
  },
  {
    ...
    tags: ["Distributed", "Orchestration", "Security"],
    status: "Active",
    desc: "Architecture for coordinating multiple autonomous sub-agents for parallel security operations. Supports task delegation, context isolation, and coordinated execution across cybersecurity domains — from reconnaissance to remediation.",
    links: {
      github: "https://github.com/skappafrost",
    },
  },
